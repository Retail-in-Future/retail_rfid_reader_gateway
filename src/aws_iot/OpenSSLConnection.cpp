...
namespace network {
    OpenSSLConnection::OpenSSLConnection(string endpoint, uint16_t endpoint_port,
    ...
    OpenSSLConnection::OpenSSLConnection(string endpoint,
            uint16_t endpoint_port,
            string root_ca_location,
            string device_cert_location,
            string device_private_key_location,
            std::chrono::milliseconds tls_handshake_timeout,
            std::chrono::milliseconds tls_read_timeout,
            std::chrono::milliseconds tls_write_timeout,
            bool server_verification_flag)
    ...
    ResponseCode OpenSSLConnection::WriteInternal(const string &buf, size_t &size_written_bytes_out) {
        int error_code = 0;
